...
class TeamTrialsLogic:
    ...
    def navigate_to_team_trials(self):
        ...
        if not self.check_and_repeat("assets/buttons/home/team_trials/team_trial_btn.png", max_attempts=6, delay_between=3):
        ...
        for attempt in range(5):
            ...
            if self.click_button_with_check("assets/buttons/next_btn.png", delay_after=2):
                self.main_window.log_message("Next button found and clicked during refresh check - proceeding to step 6")
                # Click race button
                if not self.click_button_with_check("assets/buttons/home/team_trials/race_btn.png", delay_after=2):
    ...
    def handle_shop_and_continue(self):
        ...
        # Check for cancel button (shop available)
        if self.check_button_exists("assets/buttons/home/team_trials/shop_btn.png"):
            self.main_window.log_message("Shop button found - shop available")
            if self.ui_tab.stop_if_shop.get():
                # Stop if shop and option is enabled
                if self.click_button_with_check("assets/buttons/home/team_trials/shop_btn.png", delay_after=2):
                ...
                if not self.click_button_with_check("assets/buttons/cancel_btn.png", delay_after=2):
        ...
        if self.click_button_with_check("assets/buttons/home/team_trials/race_again_btn.png"):
            self.main_window.log_message("Race again button Found")
            if self.check_button_exists("assets/buttons/restore_btn.png"):
                self.main_window.log_message("Restore button Found. No More Turn. Stop Bot.")
                return False
            else:
                return True
    ...
    def execute_team_trial_cycle(self):
        ...
        if not clicked_pvp_gift:
            ...
            if opponent_choice in opponent_positions:
                ...
                if not self.check_and_repeat("assets/buttons/next_btn.png",max_attempts=8,delay_between=3):
