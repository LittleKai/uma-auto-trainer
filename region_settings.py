...
class RegionSettingsWindow:
    ...
    def setup_main_regions_tab(self, parent):
        ...
        ocr_regions = [
            ...
            ("Unity Cup Turn Region", "UNITY_CUP_TURN_REGION",
             "Turn number or 'Race Day' text area for Unity Cup"),
            ("Unity Cup Year Region", "UNITY_CUP_YEAR_REGION",
             "Date/year information text area for Unity Cup"),
